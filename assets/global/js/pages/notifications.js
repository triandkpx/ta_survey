...
function makeAlert(jenis, header, content) {
    if (jenis == 'success') {
        notifContent = '<div class="alert alert-success media fade in"><p><strong>' + header + '</strong> ' + content + '</p></div>';
        generate('topRight', '', notifContent);
    } else if (jenis == 'warning') {
        notifContent = '<div class="alert alert-warning media fade in"><p><strong>' + header + '</strong> ' + content + '</p></div>';
        generate('topRight', '', notifContent);
    } else if (jenis == 'danger') {
        notifContent = '<div class="alert alert-danger media fade in"><p><strong>' + header + '</strong> ' + content + '</p></div>';
        generate('topRight', '', notifContent);
    } else if (jenis == 'dark') {
        notifContent = '<div class="alert alert-dark media fade in"><p><strong>' + header + '</strong> ' + content + '</p></div>';
        generate('topRight', '', notifContent);
    } else if (jenis == 'info') {
        notifContent = '<div class="alert alert-info media fade in"><p><strong>' + header + '</strong> ' + content + '</p></div>';
        generate('topRight', '', notifContent);
    }
}