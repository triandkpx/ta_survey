        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-md-3 portlets">
                    <div class="panel">
                        <div class="panel-header">
                            <h3><i class="icon-close"></i> <strong>Select</strong> Form Type</h3>
                        </div>
                ...
                <div class="col-md-9 portlets">
                    <div class="panel">
                        <div class="panel-header">
                            <h3><i class="icons-arrows-17"></i> <strong> Form</strong> Survey</h3>
                        </div>
                        <div class="panel-content">
                            <div class="row">
                                <div class="col-md-12">
                                ...
                                <form class="form-horizontal">
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <div class="col-md-12 m-b-10 hidden">
                                                        <label for="">Tipe Soal</label>
                                                        <input type="text" class="form-control"
                                                               value="SingleTextBox" readonly>
                                                    </div>
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-12 m-b-10">
                                                        <label for="">Jawaban</label>
                                                        <textarea type="text" class="form-control" placeholder="Jawaban"
                                                                  disabled></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-12 m-b-10">
                                                        <div class="col-md-1" style="padding-top: 6px; padding-left: 30px;">
                                                    ...
                                                    <div class="col-md-12 m-b-10">
                                                        ...
                                                        <div class="col-md-11">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                   placeholder="Jawaban Mereka" disabled>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-12 m-b-10">
                                                        ...
                                                        <input type="text" class="form-control m-b-10 form-white" placeholder="Baris 2">
                                                        <input type="text" class="form-control m-b-10 form-white" placeholder="Baris 3">
                                                    </div>
                                                    <hr>
                                                    <div class="col-md-12 m-b-10">
                                                        <label for="">Kolom</label>
                                                        <input type="text" class="form-control m-b-10 form-white" placeholder="Kolom 1">
                                                        <input type="text" class="form-control m-b-10 form-white" placeholder="Kolom 2">
                                                        <input type="text" class="form-control m-b-10 form-white" placeholder="Kolom 3">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <form method="post">
                            <div class="modal-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <input type="checkbox" class="form-control">Tambah Kolom Lainnya
                                        </div>
                                    </div>
                                </div>
                            </div>
